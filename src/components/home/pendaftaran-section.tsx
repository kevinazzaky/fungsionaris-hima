        ...
        <Reveal className="overflow-hidden rounded-3xl bg-zinc-950">
          <div className="flex flex-col gap-8 p-10 sm:flex-row sm:items-center sm:justify-between sm:p-14">
            <div className="max-w-lg">
              ...
              <Reveal delay={340}>
                <p className="mt-3 text-sm leading-relaxed text-white/70">
                  Periode pendaftaran anggota baru saat ini sudah ditutup.
                  Pantau info dan syarat pendaftaran periode berikutnya lewat
                  media sosial atau halaman pendaftaran kami.
                </p>
              </Reveal>
            </div>
            ...
            <Reveal delay={440} className="flex shrink-0 flex-col gap-3 sm:items-end">
              <Link
                href="/pendaftaran"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-amber-400 px-6 py-3 text-sm font-semibold text-zinc-950 shadow-[0_0_32px_-6px_rgba(251,191,36,0.55)] transition-all hover:bg-amber-300 hover:shadow-[0_0_40px_-4px_rgba(251,191,36,0.75)]"
              >
